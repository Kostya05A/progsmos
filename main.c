    ...
    do
    {
        ...
        case '3':
            ...
            do {
                ...
                switch (sub_choice) {
                    case 'a': menu_print_matrix(matrices[matrix_index]); 
                      break;
                    case 'b': menu_fill_random(matrices[matrix_index]); 
                      break;
                    case 'c': menu_set_element(matrices[matrix_index]); 
                      break;
                    case 'd': menu_increment(matrices[matrix_index]); 
                      break;
                    case 'e': menu_decrement(matrices[matrix_index]); 
                      break;
                    case 'f': menu_get_row(matrices[matrix_index]); 
                      break;
                    case 'g': menu_get_col(matrices[matrix_index]); 
                      break;
                    case 'h': menu_transpose(&matrices[matrix_index]); 
                      break;
                    case 'i': menu_determinant(matrices[matrix_index]); 
                      break;
                    case 'j': menu_inverse(matrices[matrix_index]); 
                      break;
                    case 'r': printf("Возврат в главное меню...\n"); 
                      break;
